    ...
    <section className="section-padding bg-cream">
      <div className="container-grove">
        ...
        <Reveal delayMs={100} className="mt-14">
          <div className="grid grid-cols-1 gap-10 rounded-lg border border-gold/25 bg-cream-100/70 p-8 shadow-card lg:grid-cols-[1fr_280px] lg:p-12">
            <div>
              <span className="text-xs font-semibold uppercase tracking-wider text-gold-dark">
                {study.pillar}
              </span>
              <h3 className="mt-3 font-heading text-2xl font-semibold text-onyx sm:text-3xl">
                {study.district}
              </h3>
              <p className="mt-5 text-base leading-relaxed text-onyx/80">{study.execution}</p>
              ...
              <blockquote className="mt-8 flex items-start gap-3 border-t border-gold/15 pt-6">
                ...
                <div>
                  <p className="text-sm italic leading-relaxed text-onyx/80 sm:text-base">
            ...
            <div className="flex flex-col items-center justify-center rounded-lg border border-gold/30 bg-cream p-8 text-center shadow-card">
              <span className="font-heading text-5xl font-bold text-gold-dark sm:text-6xl">
                {study.metric}
              </span>
              <p className="mt-3 text-xs font-semibold uppercase tracking-[0.16em] text-onyx/60">
                {study.metricLabel}
              </p>
            </div>
          </div>
