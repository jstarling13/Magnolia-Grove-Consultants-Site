        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
          {resolved.map(({ pillar, blurb }) => (
            <Link
              ...
              className="group flex flex-col justify-between rounded-lg border border-gold/25 bg-cream p-8 shadow-card transition-all duration-300 hover:-translate-y-1 hover:border-gold/50 hover:shadow-[0_16px_40px_-12px_rgba(197,160,89,0.35)]"
            >
              <div>
