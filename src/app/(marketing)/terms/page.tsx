  ...
  return (
    <LegalLayout title="Terms of Service" lastUpdated="July 28, 2026" sections={sections}>
      ...
      <p className="mt-6 text-sm leading-relaxed text-muted-light sm:text-base">
        ...
        <strong className="text-white">Agreement</strong>&quot;), constitute a legally binding
        agreement between <strong className="text-white">Magnolia Grove Consultants, LLC</strong>, a
        Georgia limited liability company with a principal place of business in Columbus, Georgia
        (&quot;
        <strong className="text-white">Magnolia Grove</strong>,&quot; &quot;
        <strong className="text-white">the Agency</strong>,&quot; &quot;we,&quot; &quot;us,&quot; or
        ...
        magnoliagrovega.com (the &quot;<strong className="text-white">Site</strong>
        &quot;) (&quot;<strong className="text-white">Client</strong>,&quot; &quot;you,&quot; or
      ...
      <LegalSection id="acceptance" index="01" title="Acceptance of Terms">
        <p>
          <strong className="text-white">1.1 Binding Effect.</strong> By (a) accessing or using the
        ...
        <p>
          <strong className="text-white">1.2 Authority.</strong> Any individual accepting this
        ...
        <p>
          <strong className="text-white">1.3 Modifications.</strong> Magnolia Grove reserves the
        ...
        <p>
          <strong className="text-white">1.4 Eligibility.</strong> Client represents that it has
          full legal capacity and authority to enter into this Agreement and, where applicable, is
          duly organized and in good standing under the laws of its jurisdiction of formation,
          including compliance with any applicable campaign finance, lobbying disclosure, or
      ...
      <LegalSection id="scope-of-services" index="02" title="Scope of Services">
        <p>
          <strong className="text-white">2.1 Governing Documents.</strong> Magnolia Grove provides
        ...
        <p>
          <strong className="text-white">2.2 No Implied Services.</strong> No Services are owed to
        ...
        <p>
          <strong className="text-white">2.3 Client Cooperation.</strong> Client agrees to provide
        ...
        <p>
          <strong className="text-white">2.4 Third-Party Services and Platforms.</strong> Certain
        ...
        <p>
          <strong className="text-white">2.5 Change Orders.</strong> Any material change to the
          scope of an active SOW (including added deliverables, expanded scope, expedited timelines,
          or additional revision rounds beyond those specified) must be documented in a written
          change order or amended SOW signed by both Parties and may result in additional fees.
        </p>
      </LegalSection>

      <LegalSection id="intellectual-property" index="03" title="Intellectual Property Rights">
        <p>
          <strong className="text-white">3.1 Agency IP.</strong> Magnolia Grove retains sole and
        ...
        <p>
          <strong className="text-white">3.2 Client Deliverables.</strong> Subject to Section 3.3
        ...
        <p>
          <strong className="text-white">3.3 Conditions Precedent to Transfer.</strong>{" "}
          ...
          received <strong className="text-white">payment in full</strong> of all amounts due for
          the applicable SOW or invoice, including any late fees. Prior to full payment, Client is
        ...
        <p>
          <strong className="text-white">3.4 Client-Provided Materials.</strong> Client retains all
        ...
        <p>
          <strong className="text-white">3.5 Portfolio Rights.</strong> Unless otherwise agreed in
        ...
        <p>
          <strong className="text-white">3.6 Feedback.</strong> Any suggestions, ideas, or feedback
      ...
      <LegalSection id="payment-terms" index="04" title="Payment Terms & Invoicing">
        <p>
          <strong className="text-white">4.1 Fees.</strong> Fees for Services shall be set forth in
        ...
        <p>
          <strong className="text-white">4.2 Retainers.</strong> Retainer fees are due in advance of
        ...
        <p>
          <strong className="text-white">4.3 Milestone Payments.</strong> Where a SOW specifies
        ...
        <p>
          <strong className="text-white">4.4 Invoicing and Due Dates.</strong> Unless otherwise
          specified in a SOW, invoices are due within{" "}
          <strong className="text-white">fifteen (15) days</strong> of the invoice date (&quot;Net
        ...
        <p>
          <strong className="text-white">4.5 Late Fees.</strong> Any invoice not paid in full by its
          due date shall accrue a late fee equal to the lesser of{" "}
          <strong className="text-white">one and one-half percent (1.5%) per month</strong> or the
          ...
          <strong className="text-white">thirty (30) days</strong> past due, without liability for
          any resulting delay or non-performance.
        </p>
        <p>
          <strong className="text-white">4.6 Non-Refundable Deposits.</strong> Deposits collected
          for print production, media buys, third-party production costs, advertising spend, event
          costs, or other costs committed to third-party vendors on Client&apos;s behalf are{" "}
          <strong className="text-white">non-refundable</strong> once Magnolia Grove has placed the
        ...
        <p>
          <strong className="text-white">4.7 Expenses.</strong> Client shall reimburse Magnolia
          Grove for pre-approved, reasonable out-of-pocket expenses (including but not limited to
          media placement costs, printing costs, third-party licensing fees, travel, and
          software/tooling costs procured specifically for Client&apos;s engagement) in addition to
          professional fees, unless otherwise stated in the SOW.
        </p>
        <p>
          <strong className="text-white">4.8 Taxes.</strong> All fees are exclusive of applicable
        ...
        <p>
          <strong className="text-white">4.9 Collections.</strong> Client shall be responsible for
      ...
      <LegalSection id="liability" index="05" title="Limitation of Liability & Disclaimers">
        ...
        <p>
          <strong className="text-white">5.2 Third-Party Platform Disclaimer.</strong> Magnolia
          Grove is not responsible for, and disclaims all liability arising from: (a) changes to
        ...
        <p>
          <strong className="text-white">5.3 Compliance is Client&apos;s Responsibility.</strong>{" "}
        ...
        <p className="font-semibold text-white">
          ...
          <strong className="text-white">six (6) months</strong> immediately preceding the event
          giving rise to the claim.
        </p>
        <p>
          <strong className="text-white">5.6 Indemnification.</strong> Client shall indemnify,
        ...
        <p>
          <strong className="text-white">5.7 Force Majeure.</strong> Neither Party shall be liable
      ...
      <LegalSection id="confidentiality" index="06" title="Confidentiality">
        <p>
          <strong className="text-white">6.1 Definition.</strong> &quot;Confidential
        ...
        <p>
          <strong className="text-white">6.2 Mutual Obligations.</strong> Each Party agrees to: (a)
        ...
        <p>
          <strong className="text-white">6.3 Exceptions.</strong> Confidential Information does not
        ...
        <p>
          <strong className="text-white">6.4 Compelled Disclosure.</strong> If a Party is required
          by law, subpoena, or court order to disclose the other Party&apos;s Confidential
          Information, it shall, to the extent legally permitted, provide prompt written notice to
          allow the disclosing Party to seek a protective order.
        </p>
        <p>
          <strong className="text-white">6.5 Political Sensitivity.</strong> Given the sensitive
        ...
        <p>
          <strong className="text-white">6.6 Survival.</strong> The obligations of this Section 6
          shall survive termination or expiration of this Agreement for a period of{" "}
          <strong className="text-white">five (5) years</strong>, except with respect to trade
          secrets, which shall be protected for so long as they remain trade secrets under
          applicable law.
        </p>
        <p>
          <strong className="text-white">6.7 Injunctive Relief.</strong> Each Party acknowledges
          that unauthorized disclosure of Confidential Information may cause irreparable harm for
          which monetary damages would be inadequate, and the non-breaching Party shall be entitled
          to seek injunctive relief in addition to any other available remedies.
        </p>
      </LegalSection>

      <LegalSection id="termination" index="07" title="Termination">
        <p>
          <strong className="text-white">7.1 Termination for Convenience.</strong> Either Party may
          terminate an ongoing SOW or this Agreement for convenience upon{" "}
          <strong className="text-white">thirty (30) days&apos;</strong> prior written notice to the
          other Party, unless a different notice period is specified in the applicable SOW.
        </p>
        <p>
          <strong className="text-white">7.2 Termination for Cause.</strong> Either Party may
          ...
          <strong className="text-white">fifteen (15) days</strong> of written notice describing the
        ...
        <p>
          <strong className="text-white">7.3 Immediate Suspension.</strong> Magnolia Grove may
        ...
        <p>
          <strong className="text-white">7.4 Effect of Termination.</strong> Upon termination or
        ...
        <p>
          <strong className="text-white">7.5 Wind-Down.</strong> Upon termination, Magnolia Grove
      ...
      <LegalSection id="governing-law" index="08" title="Governing Law; Dispute Resolution">
        <p>
          <strong className="text-white">8.1 Governing Law.</strong> This Agreement and any dispute
          arising out of or relating to it shall be governed by and construed in accordance with the
          laws of the <strong className="text-white">State of Georgia</strong>, without regard to
          its conflict-of-laws principles.
        </p>
        <p>
          <strong className="text-white">8.2 Venue.</strong> The Parties agree that any action or
      ...
      <LegalSection id="general-provisions" index="09" title="General Provisions">
        <p>
          <strong className="text-white">9.1 Independent Contractor.</strong> Magnolia Grove is an
        ...
        <p>
          <strong className="text-white">9.2 Assignment.</strong> Client may not assign this
        ...
        <p>
          <strong className="text-white">9.3 No Third-Party Beneficiaries.</strong> This Agreement
          is intended solely for the benefit of the Parties and does not confer any rights or
          remedies upon any third party.
        </p>
        <p>
          <strong className="text-white">9.4 Severability.</strong> If any provision of this
        ...
        <p>
          <strong className="text-white">9.5 Waiver.</strong> No waiver of any provision of this
        ...
        <p>
          <strong className="text-white">9.6 Entire Agreement.</strong> This Agreement, together
          with all executed SOWs and invoices, constitutes the entire agreement between the Parties
        ...
        <p>
          <strong className="text-white">9.7 Notices.</strong> All notices under this Agreement
          shall be in writing and delivered by email (with confirmation of receipt), certified mail,
          or courier to the addresses/contacts on file for each Party.
        </p>
        <p>
          <strong className="text-white">9.8 Electronic Signatures and Communications.</strong> The
        ...
        <p>
          <strong className="text-white">9.9 Publicity.</strong> Neither Party shall use the
        ...
        <p>
          <strong className="text-white">9.10 Political Compliance Cooperation.</strong> Client
      ...
      <div className="mt-10 border-t border-gold/15 pt-8">
        <h2 className="text-lg text-white">Acknowledgment</h2>
        ...
        <p className="mt-6 text-sm leading-relaxed text-muted-light">
          <strong className="text-white">Magnolia Grove Consultants, LLC</strong>
          <br />
          Columbus, Georgia
          <br />
