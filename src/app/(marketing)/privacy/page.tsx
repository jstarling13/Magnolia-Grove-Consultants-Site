...
export const metadata: Metadata = {
  ...
  description:
    "How Magnolia Grove Consultants collects, uses, and protects client and visitor data.",
};
        ...
        <div className="mt-10 flex flex-col gap-8 text-left text-sm leading-relaxed text-muted-light">
          <section>
            ...
            <p className="mt-3">
              ...
              strategy session forms — including name, organization, email, phone number, and any
              details you share about your campaign or engagement. We do not collect this
          ...
          <section>
            ...
            <p className="mt-3">
              Submitted information is used solely to evaluate and respond to your inquiry, schedule
              consultations, and — where you have engaged us — deliver contracted services. We do
              not sell, rent, or share your information with third parties for marketing purposes.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              All client engagement details, campaign strategy, and submitted data are treated as
              strictly confidential and are shared internally only with team members directly
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              described above, and take reasonable technical and organizational measures to protect
              it against unauthorized access, alteration, or disclosure.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Questions about this policy can be directed to {brand.name} using the contact details
