  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-onyx px-6 text-center">
      ...
      <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 rounded-full border border-gold px-8 py-3 text-sm font-semibold uppercase tracking-wide text-gold-bright transition hover:bg-gold hover:text-onyx"
        >
          Return Home
        </Link>
      </div>
