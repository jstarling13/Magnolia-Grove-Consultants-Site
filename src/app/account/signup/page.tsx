...
const inputClasses =
  "mt-2 w-full rounded-md border border-gold/25 bg-cream px-4 py-3 text-sm text-onyx placeholder:text-onyx/50 focus:outline-none focus:ring-2 focus:ring-gold/60";
const labelClasses = "mt-4 block text-sm font-medium text-onyx/80";
  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-6 py-20">
      ...
      >
        ...
        <h1 className="mt-6 text-xl font-semibold text-onyx">Create an Account</h1>
