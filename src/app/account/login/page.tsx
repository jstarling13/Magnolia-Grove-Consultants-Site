  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-6 py-20">
      ...
      >
        ...
        <h1 className="mt-6 text-xl font-semibold text-white">Client Login</h1>
        <p className="mt-2 text-sm text-muted">
          Track your requests and speed up future submissions.
        </p>

        <label htmlFor="email" className="mt-6 block text-sm font-medium text-muted-light">
          Email
        </label>
        <input
          id="email"
        ...
        <p className="mt-4 text-center text-xs text-muted">
          ...
          <Link href="/account/signup" className="text-gold-bright hover:underline">
            Create one
          </Link>
        </p>
      </form>
